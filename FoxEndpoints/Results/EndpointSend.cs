...
namespace FoxEndpoints.Results;
...
public class EndpointSend<TResponse>
{
	...
	private static readonly Task<IResult> CachedNoContent = Task.FromResult<IResult>(HttpResults.NoContent());
	private static readonly Task<IResult> CachedOkEmpty = Task.FromResult<IResult>(HttpResults.Ok());
	private static readonly Task<IResult> CachedNotFoundEmpty = Task.FromResult<IResult>(HttpResults.NotFound());
	private static readonly Task<IResult> CachedUnauthorized = Task.FromResult<IResult>(HttpResults.Unauthorized());
	...
	public Task<IResult> NotFoundAsync(string message)
	{
		...
		return Task.FromResult<IResult>(HttpResults.NotFound(problemDetails));
	}
	...
	public Task<IResult> BadRequestAsync(string message)
	{
		...
		return Task.FromResult<IResult>(HttpResults.BadRequest(problemDetails));
	}
	...
	public Task<IResult> UnauthorizedAsync(string message)
	{
		...
		return Task.FromResult<IResult>(HttpResults.Problem(problemDetails));
	}
	...
	public Task<IResult> ConflictAsync(string message)
	{
		...
		return Task.FromResult<IResult>(HttpResults.Conflict(problemDetails));
	}
