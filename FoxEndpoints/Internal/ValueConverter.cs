...
internal static class ValueConverter
{
    public static object? Convert(object? value, Type targetType)
    {
        ...
        if (underlyingNumeric == typeof(double) || underlyingNumeric == typeof(float) || underlyingNumeric == typeof(decimal))
        ...
        {
            if (underlyingNumeric == typeof(DateTime) && DateTime.TryParse(stringValue, CultureInfo.InvariantCulture, DateTimeStyles.RoundtripKind, out var dt))
                return dt;
            if (underlyingNumeric == typeof(DateTimeOffset) && DateTimeOffset.TryParse(stringValue, CultureInfo.InvariantCulture, DateTimeStyles.RoundtripKind, out var dto))
                return dto;
